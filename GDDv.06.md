...
**GDD Skeleton v.06 (for MVP + Prototype)**

Owner: Team of 3 (Design / Code / Art+Audio) | Engine: Unity | Status: **v0.6 (Updated)**
...
| **Field**     | **Value**                                                                                                                         |
| ------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| Version       | **v0.6 — 22 Nov 2025** **[อัปเดต v0.6]**                                                                                          |
...
| **Changelog** | **v0.6: เพิ่ม Reactive Timeline (§2), Advanced Combos (§4.3), Sanity Thresholds (§6), Field Resonance (§8.1)** |
...
### Action Phase (Reactive Timeline)

- **[กฎใหม่ v0.6]** `TimelineManager` จะจัดการคิวการกระทำแบบ **Dynamic Queue**
- **[กฎใหม่ v0.6]** ลำดับเทิร์น (Turn Order) จะเรียงตาม **"ตัวละคร" (Actor)** (Player 1, 2, 3 และ Boss) โดยอิงค่าความว่องไว (Agility/SPD)
- **[กฎใหม่ v0.6]** เมื่อถึงตาของ Actor จะเริ่มดำเนินการ 3 Actions ตามลำดับเวลา (Sequential Execution)
- **[Reactive System]** การกระทำบางอย่างสามารถ **"ขัดจังหวะ" (Interrupt)** หรือ **"ยกเลิก" (Cancel)** Action ในอนาคตของเป้าหมายได้ (เช่น การ Stun ขณะที่บอสกำลังร่ายเวทย์ จะทำให้ Action ถัดไปของบอสถูกยกเลิก)
...
### 4.2 3-Moves Combos (Basic)

(per char) ให้ช่องคำสั่งทั้ง 3 เป็น A1→A2→A3 แนวคิดพื้นฐานคือตัวคูณที่เรียบง่ายและเข้าใจได้
...
### 4.3 Advanced Combo System (v0.6)

ระบบคอมโบขั้นสูงที่ขึ้นอยู่กับ **Class** และ **Mechanic** ของตัวละคร (Override Basic Combos):

- **Class-Specific Finishers:**
    - **Juggernaut (D-A-A):** เปลี่ยนเป็น **"Counter Stance"** (ไม่โจมตีทันที แต่รอสวนกลับเมื่อถูกโจมตี แรงตาม DEF)
    - **Warlord (A-A-A):** ท่าสุดท้ายเปลี่ยนเป็น **"Execution Strike"** (Multi-hit + โบนัสตาม HP ที่หายไปของศัตรู)
    - **Magister (N-N-N):** เปลี่ยนเป็น **"Mind Break"** (ฟื้น Sanity เต็มหลอด + แจก Debuff ศัตรู)
- **Mechanic-Based:** คอมโบอาจเปลี่ยนไปตาม **Field Resonance** หรือ **Sanity State** ณ ขณะนั้น
...
### 6.1 Sanity Thresholds (Risk/Reward)

ค่า Sanity ส่งผลต่อสถานะของตัวละคร (Thresholds):

- **Lucid (70-100%):** สติสัมปชัญญะสมบูรณ์
    - **Bonus:** +DEF, +Status Resist
    - **Malus:** None
- **Strained (30-69%):** ภาวะปกติ (Normal State)
- **Fractured (<30%):** สติแตก (High Risk High Reward)
    - **Bonus:** **+ATK สูงมาก**, **+Crit Rate สูงมาก**
    - **Malus:** **-DEF มหาศาล**, มีโอกาสติดสถานะ "Panic" (ควบคุมไม่ได้)
...
### 8.1 Field Resonance (สภาพแวดล้อมสนามรบ)

การใช้การ์ดธาตุต่างๆ จะส่งผลต่อสภาพแวดล้อมของสนามรบ (Tug of War):

- **Logos Dominance (สนามแห่งกฎเกณฑ์):** เกิดขึ้นเมื่อมีการใช้การ์ด Logos ต่อเนื่อง
    - **Effect:** +DEF ทั้งสองฝ่าย, -Crit Chance (เน้นความแน่นอน ลดความเสี่ยง)
- **Illogic Dominance (สนามแห่งความโกลาหล):** เกิดขึ้นเมื่อมีการใช้การ์ด Illogic ต่อเนื่อง
    - **Effect:** +Crit Rate มหาศาล, -DEF ทั้งสองฝ่าย (เน้นวัดดวง High Variance)
- **Nihil Dominance (ความว่างเปล่า):** เกิดขึ้นเมื่อมีการใช้การ์ด Nihil ต่อเนื่อง
    - **Effect:** ล้างบัฟ (Buff) และดีบัฟ (Debuff) ทั้งหมดทิ้งเมื่อจบรอบ (Reset State)
...
- **[New] ComboDefinition:** สูตรคอมโบ (Input Sequence + Class Requirement -> Result Command)

### Managers

- BattleState, **TimelineManager** (จัดการคิวแบบ Reactive), DeckManager (จัดการจั่ว/ล็อก/ทิ้ง), EffectResolver, UIController, **FieldManager** (จัดการ Field Resonance)
...
- **Design Patterns:**
    - **Command Pattern:** ใช้กับ Action ทั้งหมด (Attack, Defend, Card) เพื่อรองรับ Queue และ Interrupt
    - **State Pattern:** ใช้กับ Battle Phase (Setup, Planning, Execution, Resolution)
